...
## **4.2 Summary Statistics and Boxplots**
Let's examine the summary statistics and boxplots of Avg, SR and Salary variables.

### **4.2.1 Descriptive statistics and Boxplot of Average run rate**
```{r, warning=FALSE, fig.align="center", fig.dim=c(4,4), class.source="bg-danger", class.output="bg-success"}
summary(ipl.df$Avg)
boxplot(ipl.df$Avg)
title("Batting Average of players")
```

### **4.2.2 Descriptive statistics and boxplot of strike rate**
```{r, warning=FALSE, fig.align="center", fig.dim=c(4,4), class.source="bg-danger", class.output="bg-success"}
summary(ipl.df$SR)
boxplot(ipl.df$SR)
...
### **4.2.3 Descriptive statistics and boxplot of Salary**
```{r, warning=FALSE, fig.align="center", fig.dim=c(4,4), class.source="bg-danger", class.output="bg-success"}
...
##  **4.4 Plots**
### **4.4.1 Barplot of batting average of all players**
...
### **4.4.2 Barplot of salary of all players**
```{r, warning=FALSE, fig.dim=c(8,10), fig.align = "center", class.source="bg-danger", class.output="bg-success", message=FALSE}
...
### **4.4.3 Scatter plot of salary vs batting average**
...
p3 <- ipl.df1 %>%
  ...
  labs(x = "Batting average by players",
       y = "Salary in USD million",
...
### **4.4.4 Scatter plot of salary vs strike rate**
...
## **4.5 Karl Pearson Correlation coefficients**
```{r, warning = FALSE, class.source="bg-danger", class.output="bg-success", message = FALSE}
